 ...
 */
public class Ellipse implements java.io.Serializable, Shape2D {
     ...
     */
    public Ellipse(gdx.math.Ellipse ellipse) {
        this.x = ellipse.x;
        this.y = ellipse.y;
     ...
     */
    public void set(gdx.math.Ellipse ellipse) {
        x = ellipse.x;
        y = ellipse.y;
        width = ellipse.width;
     ...
     */
    public gdx.math.Ellipse setPosition(Vector2 position) {
        this.x = position.x;
        this.y = position.y;
     ...
     * @return this ellipse for chaining
     */
    public gdx.math.Ellipse setPosition(float x, float y) {
        this.x = x;
        this.y = y;
     ...
     * @return this ellipse for chaining
     */
    public gdx.math.Ellipse setSize(float width, float height) {
        this.width = width;
        this.height = height;
    ...
    public boolean equals(Object o) {
        ...
        gdx.math.Ellipse e = (gdx.math.Ellipse) o;
