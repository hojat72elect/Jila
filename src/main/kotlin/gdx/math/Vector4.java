 ...
 */
public class Vector4 implements java.io.Serializable, Vector<gdx.math.Vector4> {

    public final static gdx.math.Vector4 X = new gdx.math.Vector4(1, 0, 0, 0);
    public final static gdx.math.Vector4 Y = new gdx.math.Vector4(0, 1, 0, 0);
    public final static gdx.math.Vector4 Z = new gdx.math.Vector4(0, 0, 1, 0);
    public final static gdx.math.Vector4 W = new gdx.math.Vector4(0, 0, 0, 1);
    public final static gdx.math.Vector4 Zero = new gdx.math.Vector4(0, 0, 0, 0);
     ...
     */
    public Vector4(final gdx.math.Vector4 vector) {
     ...
     */
    public gdx.math.Vector4 set(float x, float y, float z, float w) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.w = w;
    ...
    @Override
    public gdx.math.Vector4 set(final gdx.math.Vector4 vector) {
     ...
     * @return this vector for chaining
     */
    public gdx.math.Vector4 set(final float[] values) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 set(final Vector2 vector, float z, float w) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 set(final Vector3 vector, float w) {
        return this.set(vector.x, vector.y, vector.z, w);
    }

    @Override
    public gdx.math.Vector4 setToRandomDirection() {
    ...
    @Override
    public gdx.math.Vector4 cpy() {
        return new gdx.math.Vector4(this);
    }

    @Override
    public gdx.math.Vector4 add(final gdx.math.Vector4 vector) {
     ...
     * @return This vector for chaining.
     */
    public gdx.math.Vector4 add(float x, float y, float z, float w) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 add(float values) {
        return this.set(this.x + values, this.y + values, this.z + values, this.w + values);
    }

    @Override
    public gdx.math.Vector4 sub(final gdx.math.Vector4 a_vec) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 sub(float x, float y, float z, float w) {
        return this.set(this.x - x, this.y - y, this.z - z, this.w - w);
    }
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 sub(float value) {
     ...
     */
    @Override
    public gdx.math.Vector4 scl(float scalar) {
     ...
     */
    @Override
    public gdx.math.Vector4 scl(final gdx.math.Vector4 other) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector4 scl(float vx, float vy, float vz, float vw) {
        return this.set(this.x * vx, this.y * vy, this.z * vz, this.w * vw);
    }

    @Override
    public gdx.math.Vector4 mulAdd(gdx.math.Vector4 vec, float scalar) {
        this.x += vec.x * scalar;
        this.y += vec.y * scalar;
        this.z += vec.z * scalar;
        this.w += vec.w * scalar;
    ...
    @Override
    public gdx.math.Vector4 mulAdd(gdx.math.Vector4 vec, gdx.math.Vector4 mulVec) {
     ...
     */
    public boolean idt(final gdx.math.Vector4 vector) {
        return x == vector.x && y == vector.y && z == vector.z && w == vector.w;
    }

    @Override
    public float dst(final gdx.math.Vector4 vector) {
    ...
    @Override
    public float dst2(gdx.math.Vector4 point) {
    ...
    @Override
    public float dot(final gdx.math.Vector4 vector) {
        return x * vector.x + y * vector.y + z * vector.z + w * vector.w;
    }
     ...
     */
    @Override
    public boolean isOnLine(gdx.math.Vector4 other, float epsilon) {
     ...
     */
    @Override
    public boolean isOnLine(gdx.math.Vector4 other) {
     ...
     */
    @Override
    public boolean isCollinear(gdx.math.Vector4 other, float epsilon) {
     ...
     */
    @Override
    public boolean isCollinear(gdx.math.Vector4 other) {
     ...
     */
    @Override
    public boolean isCollinearOpposite(gdx.math.Vector4 other, float epsilon) {
     ...
     */
    @Override
    public boolean isCollinearOpposite(gdx.math.Vector4 other) {
        return isOnLine(other) && hasOppositeDirection(other);
    }

    @Override
    public boolean isPerpendicular(gdx.math.Vector4 vector) {
        return MathUtils.isZero(dot(vector));
    }

    @Override
    public boolean isPerpendicular(gdx.math.Vector4 vector, float epsilon) {
        return MathUtils.isZero(dot(vector), epsilon);
    }

    @Override
    public boolean hasSameDirection(gdx.math.Vector4 vector) {
        return dot(vector) > 0;
    }

    @Override
    public boolean hasOppositeDirection(gdx.math.Vector4 vector) {
        return dot(vector) < 0;
    }

    @Override
    public gdx.math.Vector4 lerp(final gdx.math.Vector4 target, float alpha) {
        x += alpha * (target.x - x);
        y += alpha * (target.y - y);
        z += alpha * (target.z - z);
        w += alpha * (target.w - w);
    ...
    @Override
    public gdx.math.Vector4 interpolate(gdx.math.Vector4 target, float alpha, Interpolation interpolator) {
     ...
     */
    public gdx.math.Vector4 fromString(String v) {
        int s0 = v.indexOf(',', 1);
    ...
    @Override
    public gdx.math.Vector4 limit(float limit) {
        return limit2(limit * limit);
    }

    @Override
    public gdx.math.Vector4 limit2(float limit2) {
        float len2 = len2();
        if (len2 > limit2) {
    ...
    @Override
    public gdx.math.Vector4 setLength(float len) {
        return setLength2(len * len);
    }

    @Override
    public gdx.math.Vector4 setLength2(float len2) {
        float oldLen2 = len2();
        return (oldLen2 == 0 || oldLen2 == len2) ? this : scl((float) Math.sqrt(len2 / oldLen2));
    }

    @Override
    public gdx.math.Vector4 clamp(float min, float max) {
    ...
    public boolean equals(Object obj) {
        ...
        gdx.math.Vector4 other = (gdx.math.Vector4) obj;
    ...
    @Override
    public boolean epsilonEquals(final gdx.math.Vector4 other, float epsilon) {
     ...
     */
    public boolean epsilonEquals(final gdx.math.Vector4 other) {
    ...
    @Override
    public gdx.math.Vector4 setZero() {
        this.x = 0;
        this.y = 0;
        this.z = 0;
        this.w = 0;
