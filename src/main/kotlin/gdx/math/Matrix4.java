...
public class Matrix4 implements java.io.Serializable {
    ...
    static final gdx.math.Matrix4 tmpMat = new gdx.math.Matrix4();
     ...
     */
    public Matrix4(gdx.math.Matrix4 matrix) {
        set(matrix);
    }
	...
	*/
     ...
     */
    public gdx.math.Matrix4 set(gdx.math.Matrix4 matrix) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 set(float[] values) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 set(Quaternion quaternion) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 set(float quaternionX, float quaternionY, float quaternionZ, float quaternionW) {
     ...
     */
    public gdx.math.Matrix4 set(Vector3 position, Quaternion orientation) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 set(float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 set(Vector3 position, Quaternion orientation, Vector3 scale) {
     ...
     */
    public gdx.math.Matrix4 set(Vector3 xAxis, Vector3 yAxis, Vector3 zAxis, Vector3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
     ...
     */
    public gdx.math.Matrix4 cpy() {
        return new gdx.math.Matrix4(this);
    }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 trn(Vector3 vector) {
        val[M03] += vector.x;
        val[M13] += vector.y;
        val[M23] += vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 trn(float x, float y, float z) {
        val[M03] += x;
        val[M13] += y;
        val[M23] += z;
        return this;
     ...
     */
    public gdx.math.Matrix4 mul(gdx.math.Matrix4 matrix) {
        mul(val, matrix.val);
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining operations together.
     */
    public gdx.math.Matrix4 mulLeft(gdx.math.Matrix4 matrix) {
        tmpMat.set(matrix);
        mul(tmpMat.val, val);
        return set(tmpMat);
    }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToProjection(float near, float far, float fovy, float aspectRatio) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToProjection(float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToOrtho2D(float x, float y, float width, float height) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToOrtho2D(float x, float y, float width, float height, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToOrtho(float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setTranslation(Vector3 vector) {
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setTranslation(float x, float y, float z) {
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToTranslation(Vector3 vector) {
        idt();
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToTranslation(float x, float y, float z) {
        idt();
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToTranslationAndScaling(Vector3 translation, Vector3 scaling) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToTranslationAndScaling(float translationX, float translationY, float translationZ, float scalingX,
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToRotation(Vector3 axis, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToRotationRad(Vector3 axis, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToRotation(float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToRotationRad(float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together
     */
    public gdx.math.Matrix4 setToRotation(final Vector3 v1, final Vector3 v2) {
     ...
     * @return This matrix for the purpose of chaining methods together
     */
    public gdx.math.Matrix4 setToRotation(final float x1, final float y1, final float z1, final float x2, final float y2, final float z2) {
     ...
     * @return This matrix
     */
    public gdx.math.Matrix4 setFromEulerAngles(float yaw, float pitch, float roll) {
     ...
     * @return This matrix
     */
    public gdx.math.Matrix4 setFromEulerAnglesRad(float yaw, float pitch, float roll) {
     ...
     * @return This matrix for chaining.
     */
    public gdx.math.Matrix4 setToScaling(Vector3 vector) {
        idt();
        val[M00] = vector.x;
        val[M11] = vector.y;
        val[M22] = vector.z;
     ...
     * @return This matrix for chaining.
     */
    public gdx.math.Matrix4 setToScaling(float x, float y, float z) {
        idt();
        val[M00] = x;
        val[M11] = y;
        val[M22] = z;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 setToLookAt(Vector3 direction, Vector3 up) {
     ...
     * @return This matrix
     */
    public gdx.math.Matrix4 setToLookAt(Vector3 position, Vector3 target, Vector3 up) {
    ...
    public gdx.math.Matrix4 setToWorld(Vector3 position, Vector3 forward, Vector3 up) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 lerp(gdx.math.Matrix4 matrix, float alpha) {
        for (int i = 0; i < 16; i++)
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 avg(gdx.math.Matrix4 other, float w) {
        getScale(tmpVec);
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 avg(gdx.math.Matrix4[] t) {
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 avg(gdx.math.Matrix4[] t, float[] w) {
     ...
     * @param mat the matrix
     */
    public gdx.math.Matrix4 set(Matrix3 mat) {
        val[0] = mat.val[0];
        val[1] = mat.val[1];
        val[2] = mat.val[2];
        val[3] = 0;
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 set(Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M20] = 0;
        val[M30] = 0;
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 setAsAffine(Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M01] = affine.m01;
        val[M11] = affine.m11;
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 setAsAffine(gdx.math.Matrix4 mat) {
        val[M00] = mat.val[M00];
        val[M10] = mat.val[M10];
        val[M01] = mat.val[M01];
        val[M11] = mat.val[M11];
    ...
    public gdx.math.Matrix4 scl(Vector3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        val[M22] *= scale.z;
        return this;
    ...
    public gdx.math.Matrix4 scl(float x, float y, float z) {
        val[M00] *= x;
        val[M11] *= y;
        val[M22] *= z;
        return this;
    ...
    public gdx.math.Matrix4 scl(float scale) {
        val[M00] *= scale;
        val[M11] *= scale;
        val[M22] *= scale;
        return this;
     ...
     */
    public gdx.math.Matrix4 toNormalMatrix() {
        val[M03] = 0;
        val[M13] = 0;
        val[M23] = 0;
        return inv().tra();
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 translate(Vector3 translation) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 translate(float x, float y, float z) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 rotate(Vector3 axis, float degrees) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 rotateRad(Vector3 axis, float radians) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 rotate(float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 rotateRad(float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 rotate(Quaternion rotation) {
     ...
     * @return This matrix for the purpose of chaining methods together
     */
    public gdx.math.Matrix4 rotate(final Vector3 v1, final Vector3 v2) {
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 rotateTowardDirection(final Vector3 direction, final Vector3 up) {
        l_vez.set(direction).nor();
        l_vex.set(direction).crs(up).nor();
        l_vey.set(l_vex).crs(l_vez).nor();
     ...
     * @return This matrix for chaining
     */
    public gdx.math.Matrix4 rotateTowardTarget(final Vector3 target, final Vector3 up) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public gdx.math.Matrix4 scale(float scaleX, float scaleY, float scaleZ) {
        val[M00] *= scaleX;
        val[M01] *= scaleY;
        val[M02] *= scaleZ;
        val[M10] *= scaleX;
