...
public class GridPoint2 implements java.io.Serializable {
     ...
     */
    public GridPoint2(gdx.math.GridPoint2 point) {
        this.x = point.x;
        this.y = point.y;
    }
     ...
     */
    public gdx.math.GridPoint2 set(gdx.math.GridPoint2 point) {
        this.x = point.x;
        this.y = point.y;
        return this;
    }
     ...
     * @return this 2D grid point for chaining.
     */
    public gdx.math.GridPoint2 set(int x, int y) {
        this.x = x;
        this.y = y;
        return this;
    }
     ...
     */
    public float dst2(gdx.math.GridPoint2 other) {
        int xd = other.x - x;
        int yd = other.y - y;
     ...
     */
    public float dst(gdx.math.GridPoint2 other) {
        int xd = other.x - x;
        int yd = other.y - y;
     ...
     * @return this 2d grid point for chaining.
     */
    public gdx.math.GridPoint2 add(gdx.math.GridPoint2 other) {
        x += other.x;
        y += other.y;
        return this;
    }
     ...
     * @return this 2d grid point for chaining.
     */
    public gdx.math.GridPoint2 add(int x, int y) {
        this.x += x;
        this.y += y;
        return this;
    }
     ...
     * @return this 2d grid point for chaining.
     */
    public gdx.math.GridPoint2 sub(gdx.math.GridPoint2 other) {
        x -= other.x;
        y -= other.y;
        return this;
    }
     ...
     * @return this 2d grid point for chaining.
     */
    public gdx.math.GridPoint2 sub(int x, int y) {
        this.x -= x;
        this.y -= y;
        return this;
    }
     ...
     */
    public gdx.math.GridPoint2 cpy() {
        return new gdx.math.GridPoint2(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        gdx.math.GridPoint2 g = (gdx.math.GridPoint2) o;
