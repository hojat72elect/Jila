...
import gdx.utils.Scaling;

/**
 * Encapsulates a 2D rectangle defined by its corner point in the bottom left and its extents in x (width) and y (height).
 */
public class Rectangle implements java.io.Serializable, Shape2D {
    /**
     * Static temporary rectangle. Use with care! Use only when sure other code will not also use this.
     */
    static public final gdx.math.Rectangle tmp = new gdx.math.Rectangle();

    /**
     * Static temporary rectangle. Use with care! Use only when sure other code will not also use this.
     */
    static public final gdx.math.Rectangle tmp2 = new gdx.math.Rectangle();
     ...
     */
    public Rectangle(gdx.math.Rectangle rect) {
        x = rect.x;
        y = rect.y;
        width = rect.width;
        height = rect.height;
     ...
     */
    public gdx.math.Rectangle set(float x, float y, float width, float height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setX(float x) {
        this.x = x;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setY(float y) {
        this.y = y;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setWidth(float width) {
        this.width = width;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setHeight(float height) {
        this.height = height;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setPosition(Vector2 position) {
        this.x = position.x;
        this.y = position.y;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setPosition(float x, float y) {
        this.x = x;
        this.y = y;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setSize(float width, float height) {
        this.width = width;
        this.height = height;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle setSize(float sizeXY) {
        this.width = sizeXY;
        this.height = sizeXY;
     ...
     */
    public boolean contains(gdx.math.Rectangle rectangle) {
     ...
     */
    public boolean overlaps(gdx.math.Rectangle r) {
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle set(gdx.math.Rectangle rect) {
        this.x = rect.x;
        this.y = rect.y;
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle merge(gdx.math.Rectangle rect) {
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle merge(float x, float y) {
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle merge(Vector2 vec) {
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle merge(Vector2[] vecs) {
        float minX = x;
        float maxX = x + width;
        float minY = y;
        float maxY = y + height;
     ...
     */
    public gdx.math.Rectangle setCenter(float x, float y) {
     ...
     * @return this for chaining
     */
    public gdx.math.Rectangle setCenter(Vector2 position) {
     ...
     * @see Scaling
     */
    public gdx.math.Rectangle fitOutside(gdx.math.Rectangle rect) {
     ...
     * @see Scaling
     */
    public gdx.math.Rectangle fitInside(gdx.math.Rectangle rect) {
        float ratio = getAspectRatio();
     ...
     * @return this rectangle for chaining
     */
    public gdx.math.Rectangle fromString(String v) {
        int s0 = v.indexOf(',', 1);
    ...
    public boolean equals(Object obj) {
        ...
        gdx.math.Rectangle other = (gdx.math.Rectangle) obj;
