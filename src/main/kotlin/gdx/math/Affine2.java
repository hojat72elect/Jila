...
public final class Affine2 implements java.io.Serializable {
     ...
     */
    public Affine2(gdx.math.Affine2 other) {
        set(other);
    }
     ...
     */
    public gdx.math.Affine2 set(gdx.math.Affine2 other) {
        m00 = other.m00;
        m01 = other.m01;
        m02 = other.m02;
        m10 = other.m10;
     ...
     * @return This matrix for the purposes of chaining.
     */
    public gdx.math.Affine2 set(Matrix3 matrix) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 set(Matrix4 matrix) {
        float[] other = matrix.val;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTranslation(float x, float y) {
        m00 = 1;
        m01 = 0;
        m02 = x;
        m10 = 0;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTranslation(Vector2 trn) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToScaling(float scaleX, float scaleY) {
        m00 = scaleX;
        m01 = 0;
        m02 = 0;
        m10 = 0;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToScaling(Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToRotation(float degrees) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToRotationRad(float radians) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToRotation(float cos, float sin) {
        m00 = cos;
        m01 = -sin;
        m02 = 0;
        m10 = sin;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToShearing(float shearX, float shearY) {
        m00 = 1;
        m01 = shearX;
        m02 = 0;
        m10 = shearY;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToShearing(Vector2 shear) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnRotScl(float x, float y, float degrees, float scaleX, float scaleY) {
        m02 = x;
        m12 = y;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnRotScl(Vector2 trn, float degrees, Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnRotRadScl(float x, float y, float radians, float scaleX, float scaleY) {
        m02 = x;
        m12 = y;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnRotRadScl(Vector2 trn, float radians, Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnScl(float x, float y, float scaleX, float scaleY) {
        m00 = scaleX;
        m01 = 0;
        m02 = x;
        m10 = 0;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToTrnScl(Vector2 trn, Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 setToProduct(gdx.math.Affine2 l, gdx.math.Affine2 r) {
     ...
     */
    public gdx.math.Affine2 mul(gdx.math.Affine2 other) {
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public gdx.math.Affine2 preMul(gdx.math.Affine2 other) {
     ...
     */
    public gdx.math.Affine2 translate(float x, float y) {
        m02 += m00 * x + m01 * y;
        m12 += m10 * x + m11 * y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 translate(Vector2 trn) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preTranslate(float x, float y) {
        m02 += x;
        m12 += y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preTranslate(Vector2 trn) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 scale(float scaleX, float scaleY) {
        m00 *= scaleX;
        m01 *= scaleY;
        m10 *= scaleX;
        m11 *= scaleY;
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 scale(Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preScale(float scaleX, float scaleY) {
        m00 *= scaleX;
        m01 *= scaleX;
        m02 *= scaleX;
        m10 *= scaleY;
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preScale(Vector2 scale) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 rotate(float degrees) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 rotateRad(float radians) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preRotate(float degrees) {
        if (degrees == 0) return this;
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preRotateRad(float radians) {
        if (radians == 0) return this;
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 shear(float shearX, float shearY) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 shear(Vector2 shear) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preShear(float shearX, float shearY) {
     ...
     * @return This matrix for the purpose of chaining.
     */
    public gdx.math.Affine2 preShear(Vector2 shear) {
