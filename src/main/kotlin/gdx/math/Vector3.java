 ...
 */
public class Vector3 implements java.io.Serializable, Vector<gdx.math.Vector3> {
    public final static gdx.math.Vector3 X = new gdx.math.Vector3(1, 0, 0);
    public final static gdx.math.Vector3 Y = new gdx.math.Vector3(0, 1, 0);
    public final static gdx.math.Vector3 Z = new gdx.math.Vector3(0, 0, 1);
    public final static gdx.math.Vector3 Zero = new gdx.math.Vector3(0, 0, 0);
     ...
     */
    public Vector3(final gdx.math.Vector3 vector) {
        this.set(vector);
    }
     ...
     */
    public gdx.math.Vector3 set(float x, float y, float z) {
        this.x = x;
        this.y = y;
        this.z = z;
        return this;
    ...
    @Override
    public gdx.math.Vector3 set(final gdx.math.Vector3 vector) {
     ...
     * @return this vector for chaining
     */
    public gdx.math.Vector3 set(final float[] values) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 set(final Vector2 vector, float z) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 setFromSpherical(float azimuthalAngle, float polarAngle) {
    ...
    @Override
    public gdx.math.Vector3 setToRandomDirection() {
    ...
    @Override
    public gdx.math.Vector3 cpy() {
        return new gdx.math.Vector3(this);
    }

    @Override
    public gdx.math.Vector3 add(final gdx.math.Vector3 vector) {
     ...
     * @return This vector for chaining.
     */
    public gdx.math.Vector3 add(float x, float y, float z) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 add(float values) {
        return this.set(this.x + values, this.y + values, this.z + values);
    }

    @Override
    public gdx.math.Vector3 sub(final gdx.math.Vector3 a_vec) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 sub(float x, float y, float z) {
        return this.set(this.x - x, this.y - y, this.z - z);
    }
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 sub(float value) {
        return this.set(this.x - value, this.y - value, this.z - value);
    }

    @Override
    public gdx.math.Vector3 scl(float scalar) {
        return this.set(this.x * scalar, this.y * scalar, this.z * scalar);
    }

    @Override
    public gdx.math.Vector3 scl(final gdx.math.Vector3 other) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 scl(float vx, float vy, float vz) {
        return this.set(this.x * vx, this.y * vy, this.z * vz);
    }

    @Override
    public gdx.math.Vector3 mulAdd(gdx.math.Vector3 vec, float scalar) {
        this.x += vec.x * scalar;
        this.y += vec.y * scalar;
        this.z += vec.z * scalar;
        return this;
    ...
    @Override
    public gdx.math.Vector3 mulAdd(gdx.math.Vector3 vec, gdx.math.Vector3 mulVec) {
     ...
     */
    public boolean idt(final gdx.math.Vector3 vector) {
        return x == vector.x && y == vector.y && z == vector.z;
    }

    @Override
    public float dst(final gdx.math.Vector3 vector) {
    ...
    @Override
    public float dst2(gdx.math.Vector3 point) {
    ...
    @Override
    public float dot(final gdx.math.Vector3 vector) {
        return x * vector.x + y * vector.y + z * vector.z;
    }
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 crs(final gdx.math.Vector3 vector) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 crs(float x, float y, float z) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 mul4x3(float[] matrix) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 mul(final Matrix4 matrix) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 traMul(final Matrix4 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 mul(Matrix3 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 traMul(Matrix3 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 mul(final Quaternion quat) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 prj(final Matrix4 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 rot(final Matrix4 matrix) {
        final float[] l_mat = matrix.val;
     ...
     */
    public gdx.math.Vector3 unrotate(final Matrix4 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * @return The vector for chaining
     */
    public gdx.math.Vector3 untransform(final Matrix4 matrix) {
        final float[] l_mat = matrix.val;
        x -= l_mat[Matrix4.M03];
        y -= l_mat[Matrix4.M03];
        z -= l_mat[Matrix4.M03];
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 rotate(float degrees, float axisX, float axisY, float axisZ) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 rotateRad(float radians, float axisX, float axisY, float axisZ) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 rotate(final gdx.math.Vector3 axis, float degrees) {
     ...
     * @return This vector for chaining
     */
    public gdx.math.Vector3 rotateRad(final gdx.math.Vector3 axis, float radians) {
    ...
    @Override
    public boolean isOnLine(gdx.math.Vector3 other, float epsilon) {
        return len2(y * other.z - z * other.y, z * other.x - x * other.z, x * other.y - y * other.x) <= epsilon;
    }

    @Override
    public boolean isOnLine(gdx.math.Vector3 other) {
        return len2(y * other.z - z * other.y, z * other.x - x * other.z,
                x * other.y - y * other.x) <= MathUtils.FLOAT_ROUNDING_ERROR;
    }

    @Override
    public boolean isCollinear(gdx.math.Vector3 other, float epsilon) {
        return isOnLine(other, epsilon) && hasSameDirection(other);
    }

    @Override
    public boolean isCollinear(gdx.math.Vector3 other) {
        return isOnLine(other) && hasSameDirection(other);
    }

    @Override
    public boolean isCollinearOpposite(gdx.math.Vector3 other, float epsilon) {
        return isOnLine(other, epsilon) && hasOppositeDirection(other);
    }

    @Override
    public boolean isCollinearOpposite(gdx.math.Vector3 other) {
        return isOnLine(other) && hasOppositeDirection(other);
    }

    @Override
    public boolean isPerpendicular(gdx.math.Vector3 vector) {
        return MathUtils.isZero(dot(vector));
    }

    @Override
    public boolean isPerpendicular(gdx.math.Vector3 vector, float epsilon) {
        return MathUtils.isZero(dot(vector), epsilon);
    }

    @Override
    public boolean hasSameDirection(gdx.math.Vector3 vector) {
        return dot(vector) > 0;
    }

    @Override
    public boolean hasOppositeDirection(gdx.math.Vector3 vector) {
        return dot(vector) < 0;
    }

    @Override
    public gdx.math.Vector3 lerp(final gdx.math.Vector3 target, float alpha) {
        x += alpha * (target.x - x);
        y += alpha * (target.y - y);
        z += alpha * (target.z - z);
        return this;
    ...
    @Override
    public gdx.math.Vector3 interpolate(gdx.math.Vector3 target, float alpha, Interpolation interpolator) {
     ...
     * @return This vector for chaining.
     */
    public gdx.math.Vector3 slerp(final gdx.math.Vector3 target, float alpha) {
     ...
     * @return this vector for chaining
     */
    public gdx.math.Vector3 fromString(String v) {
        int s0 = v.indexOf(',', 1);
    ...
    @Override
    public gdx.math.Vector3 limit(float limit) {
        return limit2(limit * limit);
    }

    @Override
    public gdx.math.Vector3 limit2(float limit2) {
        float len2 = len2();
        if (len2 > limit2) {
    ...
    @Override
    public gdx.math.Vector3 setLength(float len) {
        return setLength2(len * len);
    }

    @Override
    public gdx.math.Vector3 setLength2(float len2) {
        float oldLen2 = len2();
        return (oldLen2 == 0 || oldLen2 == len2) ? this : scl((float) Math.sqrt(len2 / oldLen2));
    }

    @Override
    public gdx.math.Vector3 clamp(float min, float max) {
    ...
    public boolean equals(Object obj) {
        ...
        gdx.math.Vector3 other = (gdx.math.Vector3) obj;
    ...
    @Override
    public boolean epsilonEquals(final gdx.math.Vector3 other, float epsilon) {
     ...
     */
    public boolean epsilonEquals(final gdx.math.Vector3 other) {
    ...
    @Override
    public gdx.math.Vector3 setZero() {
        this.x = 0;
        this.y = 0;
        this.z = 0;
        return this;
