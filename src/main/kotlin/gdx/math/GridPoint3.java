 ...
 */
public class GridPoint3 implements java.io.Serializable {
     ...
     */
    public GridPoint3(gdx.math.GridPoint3 point) {
        this.x = point.x;
        this.y = point.y;
        this.z = point.z;
    }
     ...
     */
    public gdx.math.GridPoint3 set(gdx.math.GridPoint3 point) {
        this.x = point.x;
        this.y = point.y;
        this.z = point.z;
        return this;
     ...
     */
    public gdx.math.GridPoint3 set(int x, int y, int z) {
        this.x = x;
        this.y = y;
        this.z = z;
        return this;
     ...
     */
    public float dst2(gdx.math.GridPoint3 other) {
        int xd = other.x - x;
        int yd = other.y - y;
        int zd = other.z - z;
     ...
     */
    public float dst(gdx.math.GridPoint3 other) {
        int xd = other.x - x;
        int yd = other.y - y;
        int zd = other.z - z;
     ...
     */
    public gdx.math.GridPoint3 add(gdx.math.GridPoint3 other) {
        x += other.x;
        y += other.y;
        z += other.z;
        return this;
     ...
     * @return this 3d grid point for chaining.
     */
    public gdx.math.GridPoint3 add(int x, int y, int z) {
        this.x += x;
        this.y += y;
        this.z += z;
        return this;
     ...
     * @return this 3d grid point for chaining.
     */
    public gdx.math.GridPoint3 sub(gdx.math.GridPoint3 other) {
        x -= other.x;
        y -= other.y;
        z -= other.z;
        return this;
     ...
     * @return this 3d grid point for chaining.
     */
    public gdx.math.GridPoint3 sub(int x, int y, int z) {
        this.x -= x;
        this.y -= y;
        this.z -= z;
        return this;
     ...
     */
    public gdx.math.GridPoint3 cpy() {
        return new gdx.math.GridPoint3(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        gdx.math.GridPoint3 g = (gdx.math.GridPoint3) o;
