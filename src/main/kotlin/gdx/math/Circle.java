 ...
 */
public class Circle implements java.io.Serializable, Shape2D {
    public float x, y;
    public float radius;
     ...
     */
    public Circle(gdx.math.Circle circle) {
        this.x = circle.x;
        this.y = circle.y;
     ...
     */
    public void set(gdx.math.Circle circle) {
        this.x = circle.x;
        this.y = circle.y;
        this.radius = circle.radius;
    }
     ...
     */
    public boolean contains(gdx.math.Circle c) {
     ...
     */
    public boolean overlaps(gdx.math.Circle c) {
        float dx = x - c.x;
        float dy = y - c.y;
    ...
    public boolean equals(Object o) {
        ...
        gdx.math.Circle c = (gdx.math.Circle) o;
