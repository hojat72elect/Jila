package gdx.math.collision;

import gdx.math.Matrix4;
import gdx.math.Vector3;
...
public class BoundingBox implements java.io.Serializable {
     ...
     */
    public BoundingBox(gdx.math.collision.BoundingBox bounds) {
        this.set(bounds);
    }
     ...
     */
    public gdx.math.collision.BoundingBox set(gdx.math.collision.BoundingBox bounds) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox set(Vector3 minimum, Vector3 maximum) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox set(Vector3[] points) {
        this.inf();
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox set(java.util.List<Vector3> points) {
        this.inf();
        for (Vector3 l_point : points)
            this.ext(l_point);
        return this;
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox inf() {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox ext(Vector3 point) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox clr() {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox ext(gdx.math.collision.BoundingBox a_bounds) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox ext(Vector3 center, float radius) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox ext(gdx.math.collision.BoundingBox bounds, Matrix4 transform) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox mul(Matrix4 transform) {
     ...
     */
    public boolean contains(gdx.math.collision.BoundingBox b) {
     ...
     */
    public boolean intersects(gdx.math.collision.BoundingBox b) {
     ...
     * @return This bounding box for chaining.
     */
    public gdx.math.collision.BoundingBox ext(float x, float y, float z) {
