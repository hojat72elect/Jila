...
import gdx.math.Intersector;
import gdx.math.Matrix4;
import gdx.math.Vector3;

public class OrientedBoundingBox implements java.io.Serializable {
    ...
    public gdx.math.collision.OrientedBoundingBox set(BoundingBox bounds, Matrix4 transform) {
        setBounds(bounds);
     ...
     */
    public boolean contains(gdx.math.collision.OrientedBoundingBox obb) {
     ...
     * @return Whether the given bounding box is intersected
     */
    public boolean intersects(gdx.math.collision.OrientedBoundingBox obb) {
        Vector3[] aAxes = axes;
