...
public class Ray implements java.io.Serializable {
     ...
     */
    public gdx.math.collision.Ray cpy() {
        return new gdx.math.collision.Ray(this.origin, this.direction);
    }
     ...
     */
    public gdx.math.collision.Ray mul(Matrix4 matrix) {
     ...
     * @return this ray for chaining
     */
    public gdx.math.collision.Ray set(Vector3 origin, Vector3 direction) {
        this.origin.set(origin);
        this.direction.set(direction).nor();
        return this;
    }
     ...
     * @return this ray for chaining
     */
    public gdx.math.collision.Ray set(float x, float y, float z, float dx, float dy, float dz) {
     ...
     * @return This ray for chaining
     */
    public gdx.math.collision.Ray set(gdx.math.collision.Ray ray) {
    ...
    public boolean equals(Object o) {
        ...
        gdx.math.collision.Ray r = (gdx.math.collision.Ray) o;
