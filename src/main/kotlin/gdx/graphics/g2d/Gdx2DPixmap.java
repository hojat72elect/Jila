...
public class Gdx2DPixmap implements Disposable {
    ...
    public Gdx2DPixmap(byte[] encodedData, int offset, int len, int requestedFormat) throws java.io.IOException {
        pixelPtr = load(nativeData, encodedData, offset, len);
        if (pixelPtr == null) throw new java.io.IOException("Error loading pixmap: " + getFailureReason());
    ...
    public Gdx2DPixmap(java.nio.ByteBuffer encodedData, int offset, int len, int requestedFormat) throws java.io.IOException {
        if (!encodedData.isDirect()) throw new java.io.IOException("Couldn't load pixmap from non-direct ByteBuffer");
    ...
    public Gdx2DPixmap(java.io.InputStream in, int requestedFormat) throws java.io.IOException {
        java.io.ByteArrayOutputStream bytes = new java.io.ByteArrayOutputStream(1024);
    ...
    private static native java.nio.ByteBuffer load(long[] nativeData, byte[] buffer, int offset, int len); /*MANUAL
    ...
    private static native java.nio.ByteBuffer loadByteBuffer(long[] nativeData, java.nio.ByteBuffer buffer, int offset, int len); /*MANUAL
		if(buffer==0)
			return 0;
    ...
    private static native java.nio.ByteBuffer newPixmap(long[] nativeData, int width, int height, int format); /*MANUAL
