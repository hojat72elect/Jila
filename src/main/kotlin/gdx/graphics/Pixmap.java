...
import gdx.graphics.g2d.Gdx2DPixmap;
...
public class Pixmap implements Disposable {
    ...
    public Pixmap(int width, int height, Pixmap.Format format) {
        pixmap = new Gdx2DPixmap(width, height, Pixmap.Format.toGdx2DPixmapFormat(format));
        setColor(0, 0, 0, 0);
        fill();
    }
     ...
     * @param len         the length
     */
    public Pixmap(java.nio.ByteBuffer encodedData, int offset, int len) {
...
// public void setStrokeWidth (int width);
    ...
    public void setFilter(Pixmap.Filter filter) {
        this.filter = filter;
        pixmap.setScale(filter == Pixmap.Filter.NearestNeighbour ? Gdx2DPixmap.GDX2D_SCALE_NEAREST : Gdx2DPixmap.GDX2D_SCALE_LINEAR);
    }
