...
import gdx.graphics.Color;
import gdx.graphics.GL20;
import gdx.graphics.Mesh;
import gdx.math.*;
import gdx.utils.*;
...
public class ShaderProgram implements Disposable {
    ...
    final static java.nio.IntBuffer intbuf = BufferUtils.newIntBuffer(1);
    /**
    ...
    java.nio.IntBuffer params = BufferUtils.newIntBuffer(1);
    java.nio.IntBuffer type = BufferUtils.newIntBuffer(1);
    /**
     * the log
     **/
    private String log = "";
    ...
    private int loadShader(int type, String source) {
        GL20 gl = Gdx.gl20;
        java.nio.IntBuffer intbuf = BufferUtils.newIntBuffer(1);
...
// }
    ...
    private int linkProgram(int program) {
        ...
        java.nio.IntBuffer intbuf = tmp.asIntBuffer();
...
// }
     ...
     * @param transpose whether the uniform matrix should be transposed
     */
    public void setUniformMatrix3fv(String name, java.nio.FloatBuffer buffer, int count, boolean transpose) {
        GL20 gl = Gdx.gl20;
        checkManaged();
     ...
     * @param transpose whether the uniform matrix should be transposed
     */
    public void setUniformMatrix4fv(String name, java.nio.FloatBuffer buffer, int count, boolean transpose) {
        GL20 gl = Gdx.gl20;
        checkManaged();
        ((java.nio.Buffer) buffer).position(0);
        int location = fetchUniformLocation(name);
     ...
     */
    public void setVertexAttribute(String name, int size, int type, boolean normalize, int stride, java.nio.Buffer buffer) {
        GL20 gl = Gdx.gl20;
        checkManaged();
