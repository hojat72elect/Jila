...
import gdx.graphics.Pixmap.Format;
...
public class ETC1 {
    ...
    public static ETC1.ETC1Data encodeImage(Pixmap pixmap) {
        ...
        java.nio.ByteBuffer compressedData = encodeImage(pixmap.getPixels(), 0, pixmap.getWidth(), pixmap.getHeight(), pixelSize);
    ...
    public static ETC1.ETC1Data encodeImagePKM(Pixmap pixmap) {
        int pixelSize = getPixelSize(pixmap.getFormat());
        java.nio.ByteBuffer compressedData = encodeImagePKM(pixmap.getPixels(), 0, pixmap.getWidth(), pixmap.getHeight(), pixelSize);
        BufferUtils.newUnsafeByteBuffer(compressedData);
     ...
     * @return the Pixmap
     */
    public static Pixmap decodeImage(ETC1.ETC1Data etc1Data, Format format) {
        int dataOffset = 0;
        int width = 0;
        int height = 0;
	...
	*/
     ...
     * @param height the height in pixels
     */
    public static native void formatHeader(java.nio.ByteBuffer header, int offset, int width, int height); /*
	...
	*/
     ...
     */
    static native int getWidthPKM(java.nio.ByteBuffer header, int offset); /*
	...
	*/
     ...
     */
    static native int getHeightPKM(java.nio.ByteBuffer header, int offset); /*
	...
	*/
     ...
     * @return the width stored in the PKM header
     */
    static native boolean isValidPKM(java.nio.ByteBuffer header, int offset); /*
	...
	*/
     ...
     */
    private static native void decodeImage(java.nio.ByteBuffer compressedData, int offset, java.nio.ByteBuffer decodedData, int offsetDec,
	...
	*/
     ...
     */
    private static native java.nio.ByteBuffer encodeImage(java.nio.ByteBuffer imageData, int offset, int width, int height, int pixelSize); /*
	...
	*/
     ...
     * @return a new direct native order ByteBuffer containing the compressed image data
     */
    private static native java.nio.ByteBuffer encodeImagePKM(java.nio.ByteBuffer imageData, int offset, int width, int height, int pixelSize); /*
		int compressedSize = etc1_get_encoded_data_size(width, height);
    ...
    public final static class ETC1Data implements Disposable {
        ...
        public ETC1Data(FileHandle pkmFile) {
            ...
            try {
                ...
                ((java.nio.Buffer) compressedData).position(0);
                ((java.nio.Buffer) compressedData).limit(compressedData.capacity());
            } catch (Exception e) {
            ...
            ((java.nio.Buffer) compressedData).position(dataOffset);
            checkNPOT();
        }
        ...
        public void write(FileHandle file) {
            java.io.DataOutputStream write = null;
