...
import gdx.utils.Null;
import gdx.utils.Pool.Poolable;
...
public interface Net {
     ...
     */
    public void sendHttpRequest(gdx.Net.HttpRequest httpRequest, @Null HttpResponseListener httpResponseListener);

    public void cancelHttpRequest(gdx.Net.HttpRequest httpRequest);

    public boolean isHttpRequestPending(gdx.Net.HttpRequest httpRequest);
     ...
     */
    public ServerSocket newServerSocket(gdx.Net.Protocol protocol, String hostname, int port, ServerSocketHints hints);
     ...
     * @throws GdxRuntimeException in case the socket couldn't be opened
     */
    public ServerSocket newServerSocket(gdx.Net.Protocol protocol, int port, ServerSocketHints hints);
     ...
     * @throws GdxRuntimeException in case the socket couldn't be opened
     */
    public Socket newClientSocket(gdx.Net.Protocol protocol, String host, int port, SocketHints hints);
    ...
    public static interface HttpResponse {
         ...
         */
        java.util.Map<String, java.util.List<String>> getHeaders();
    }
    ...
    public static interface HttpResponseListener {
         ...
         */
        void handleHttpResponse(gdx.Net.HttpResponse httpResponse);
    ...
    public static class HttpRequest implements Poolable {
         ...
         */
        public void setContent(java.io.InputStream contentStream, long contentLength) {
