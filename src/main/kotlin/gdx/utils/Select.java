 ...
 */
public class Select {
    private static gdx.utils.Select instance;
    private QuickSelect quickSelect;

    /**
     * Provided for convenience
     */
    public static gdx.utils.Select instance() {
        if (instance == null) instance = new gdx.utils.Select();
        return instance;
    }
     ...
     */
    private <T> int fastMin(T[] items, java.util.Comparator<T> comp, int size) {
        int lowestIdx = 0;
     ...
     */
    private <T> int fastMax(T[] items, java.util.Comparator<T> comp, int size) {
        int highestIdx = 0;
        for (int i = 1; i < size; i++) {
