...
import gdx.math.Matrix3;
import gdx.math.Matrix4;
...
public final class BufferUtils {
    ...
    static Array<java.nio.ByteBuffer> unsafeBuffers = new Array<java.nio.ByteBuffer>();
    ...
    public static void copy(float[] src, java.nio.Buffer dst, int numFloats, int offset) {
        if (dst instanceof java.nio.ByteBuffer)
            dst.limit(numFloats << 2);
        else if (dst instanceof java.nio.FloatBuffer) dst.limit(numFloats);
    ...
    private static int positionInBytes(java.nio.Buffer dst) {
        if (dst instanceof java.nio.ByteBuffer)
            return dst.position();
        else if (dst instanceof java.nio.ShortBuffer)
            return dst.position() << 1;
        else if (dst instanceof java.nio.CharBuffer)
            return dst.position() << 1;
        else if (dst instanceof java.nio.IntBuffer)
            return dst.position() << 2;
        else if (dst instanceof java.nio.LongBuffer)
            return dst.position() << 3;
        else if (dst instanceof java.nio.FloatBuffer)
            return dst.position() << 2;
        else if (dst instanceof java.nio.DoubleBuffer)
            return dst.position() << 3;
        else
            throw new GdxRuntimeException("Can't copy to a " + dst.getClass().getName() + " instance");
    }

    private static int bytesToElements(java.nio.Buffer dst, int bytes) {
        if (dst instanceof java.nio.ByteBuffer)
            return bytes;
        else if (dst instanceof java.nio.ShortBuffer)
            return bytes >>> 1;
    ...
    private static int elementsToBytes(java.nio.Buffer dst, int elements) {
        if (dst instanceof java.nio.ByteBuffer)
            return elements;
        else if (dst instanceof java.nio.ShortBuffer)
            return elements << 1;
    ...
    public static java.nio.FloatBuffer newFloatBuffer(int numFloats) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numFloats * 4);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer.asFloatBuffer();
    }

    public static java.nio.DoubleBuffer newDoubleBuffer(int numDoubles) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numDoubles * 8);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer.asDoubleBuffer();
    }

    public static java.nio.ByteBuffer newByteBuffer(int numBytes) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numBytes);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer;
    }

    public static java.nio.ShortBuffer newShortBuffer(int numShorts) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numShorts * 2);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer.asShortBuffer();
    }

    public static java.nio.CharBuffer newCharBuffer(int numChars) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numChars * 2);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer.asCharBuffer();
    }

    public static java.nio.IntBuffer newIntBuffer(int numInts) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numInts * 4);
        buffer.order(java.nio.ByteOrder.nativeOrder());
        return buffer.asIntBuffer();
    }

    public static java.nio.LongBuffer newLongBuffer(int numLongs) {
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocateDirect(numLongs * 8);
        buffer.order(java.nio.ByteOrder.nativeOrder());
    ...
    public static java.nio.ByteBuffer newUnsafeByteBuffer(int numBytes) {
        java.nio.ByteBuffer buffer = newDisposableByteBuffer(numBytes);
        buffer.order(java.nio.ByteOrder.nativeOrder());
	...
	*/
     ...
     * or in native code.
     */
    private static native void freeMemory(java.nio.ByteBuffer buffer); /*
		free(buffer);
	 */

    private static native java.nio.ByteBuffer newDisposableByteBuffer(int numBytes); /*
	...
	*/
    ...
    private native static void copyJni(float[] src, java.nio.Buffer dst, int numFloats, int offset); /*
		memcpy(dst, src + offset, numFloats << 2 );
	*/

    private native static void copyJni(byte[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(char[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(short[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	 */

    private native static void copyJni(int[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(long[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(float[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(double[] src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/

    private native static void copyJni(java.nio.Buffer src, int srcOffset, java.nio.Buffer dst, int dstOffset, int numBytes); /*
		memcpy(dst + dstOffset, src + srcOffset, numBytes);
	*/
	...
	*/
    ...
    private native static void transformV4M4Jni(java.nio.Buffer data, int strideInBytes, int count, float[] matrix, int offsetInBytes); /*
	...
	*/
    ...
    private native static void transformV3M4Jni(java.nio.Buffer data, int strideInBytes, int count, float[] matrix, int offsetInBytes); /*
	...
	*/
    ...
    private native static void transformV2M4Jni(java.nio.Buffer data, int strideInBytes, int count, float[] matrix, int offsetInBytes); /*
	...
	*/
    ...
    private native static void transformV3M3Jni(java.nio.Buffer data, int strideInBytes, int count, float[] matrix, int offsetInBytes); /*
	...
	*/
    ...
    private native static void transformV2M3Jni(java.nio.Buffer data, int strideInBytes, int count, float[] matrix, int offsetInBytes); /*
	...
	*/
    ...
    private native static long find(java.nio.Buffer vertex, int vertexOffsetInBytes, int strideInBytes, java.nio.Buffer vertices, int verticesOffsetInBytes, int numVertices); /*
	...
	*/
    ...
    private native static long find(float[] vertex, int vertexOffsetInBytes, int strideInBytes, java.nio.Buffer vertices, int verticesOffsetInBytes, int numVertices); /*
		return find((float *)&vertex[vertexOffsetInBytes / 4], (unsigned int)(strideInBytes / 4), (float*)&vertices[verticesOffsetInBytes / 4], (unsigned int)numVertices);
	*/

    private native static long find(java.nio.Buffer vertex, int vertexOffsetInBytes, int strideInBytes, float[] vertices, int verticesOffsetInBytes, int numVertices); /*
		return find((float *)&vertex[vertexOffsetInBytes / 4], (unsigned int)(strideInBytes / 4), (float*)&vertices[verticesOffsetInBytes / 4], (unsigned int)numVertices);
	*/
	...
	*/
    ...
    private native static long find(java.nio.Buffer vertex, int vertexOffsetInBytes, int strideInBytes, java.nio.Buffer vertices, int verticesOffsetInBytes, int numVertices, float epsilon); /*
	...
	*/
    ...
    private native static long find(float[] vertex, int vertexOffsetInBytes, int strideInBytes, java.nio.Buffer vertices, int verticesOffsetInBytes, int numVertices, float epsilon); /*
		return find((float *)&vertex[vertexOffsetInBytes / 4], (unsigned int)(strideInBytes / 4), (float*)&vertices[verticesOffsetInBytes / 4], (unsigned int)numVertices, epsilon);
	*/

    private native static long find(java.nio.Buffer vertex, int vertexOffsetInBytes, int strideInBytes, float[] vertices, int verticesOffsetInBytes, int numVertices, float epsilon); /*
		return find((float *)&vertex[vertexOffsetInBytes / 4], (unsigned int)(strideInBytes / 4), (float*)&vertices[verticesOffsetInBytes / 4], (unsigned int)numVertices, epsilon);
	*/
