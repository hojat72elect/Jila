...
public class IntArray {
     ...
     * grown.
     */
    public IntArray(gdx.utils.IntArray array) {
     ...
     * @see #IntArray(int[])
     */
    static public gdx.utils.IntArray with(int... array) {
        return new gdx.utils.IntArray(array);
    }
    ...
    public void addAll(gdx.utils.IntArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(gdx.utils.IntArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(gdx.utils.IntArray array) {
        int size = this.size;
        int startSize = size;
        int[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof gdx.utils.IntArray)) return false;
        gdx.utils.IntArray array = (gdx.utils.IntArray) object;
