...
import gdx.utils.JsonWriter.OutputType;
...
public class JsonValue implements Iterable<JsonValue> {
     ...
     * May be null.
     */
    public gdx.utils.JsonValue child, parent;
    /**
     * May be null. When changing this field the parent {@link #size()} may need to be changed.
     */
    public gdx.utils.JsonValue next, prev;
    public int size;
    private gdx.utils.JsonValue.ValueType type;
    /**
     * May be null.
     */
    ...
    public JsonValue(gdx.utils.JsonValue.ValueType type) {
        this.type = type;
    }
    ...
    static private boolean isFlat(gdx.utils.JsonValue object) {
        for (gdx.utils.JsonValue child = object.child; child != null; child = child.next)
            if (child.isObject() || child.isArray()) return false;
        return true;
    }

    static private boolean isNumeric(gdx.utils.JsonValue object) {
        for (gdx.utils.JsonValue child = object.child; child != null; child = child.next)
    ...
    static private void indent(int count, java.io.Writer buffer) throws java.io.IOException {
        for (int i = 0; i < count; i++)
            buffer.append('\t');
    }
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue get(int index) {
        gdx.utils.JsonValue current = child;
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue get(String name) {
        gdx.utils.JsonValue current = child;
     ...
     */
    public gdx.utils.JsonValue.JsonIterator iterator(String name) {
        gdx.utils.JsonValue current = get(name);
        if (current == null) {
            gdx.utils.JsonValue.JsonIterator iter = new gdx.utils.JsonValue.JsonIterator();
            iter.entry = null;
            return iter;
        }
     ...
     */
    public gdx.utils.JsonValue require(int index) {
        gdx.utils.JsonValue current = get(index);
     ...
     * @throws IllegalArgumentException if the child was not found.
     */
    public gdx.utils.JsonValue require(String name) {
        gdx.utils.JsonValue current = get(name);
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue remove(int index) {
        gdx.utils.JsonValue child = get(index);
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue remove(String name) {
        gdx.utils.JsonValue child = get(name);
        if (child == null) return null;
        if (child.prev == null) {
            this.child = child.next;
            if (this.child != null) this.child.prev = null;
    ...
    public String[] asStringArray() {
        if (type != gdx.utils.JsonValue.ValueType.array)
            throw new IllegalStateException("Value is not an array: " + type);
        String[] array = new String[size];
        int i = 0;
        for (gdx.utils.JsonValue value = child; value != null; value = value.next, i++) {
            String v;
            switch (value.type) {
                case stringValue:
                    v = value.stringValue;
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue getChild(String name) {
        gdx.utils.JsonValue child = get(name);
    ...
    public gdx.utils.JsonValue.ValueType type() {
        return type;
    }

    public void setType(gdx.utils.JsonValue.ValueType type) {
        if (type == null) throw new IllegalArgumentException("type cannot be null.");
        this.type = type;
    }

    public boolean isArray() {
        return type == gdx.utils.JsonValue.ValueType.array;
    }

    public boolean isObject() {
        return type == gdx.utils.JsonValue.ValueType.object;
    }

    public boolean isString() {
        return type == gdx.utils.JsonValue.ValueType.stringValue;
    }
    ...
    public boolean isNumber() {
        return type == gdx.utils.JsonValue.ValueType.doubleValue || type == gdx.utils.JsonValue.ValueType.longValue;
    }

    public boolean isDouble() {
        return type == gdx.utils.JsonValue.ValueType.doubleValue;
    }

    public boolean isLong() {
        return type == gdx.utils.JsonValue.ValueType.longValue;
    }

    public boolean isBoolean() {
        return type == gdx.utils.JsonValue.ValueType.booleanValue;
    }

    public boolean isNull() {
        return type == gdx.utils.JsonValue.ValueType.nullValue;
    }
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue parent() {
        return parent;
    }
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue child() {
        return child;
    }
     ...
     */
    public void addChild(String name, gdx.utils.JsonValue value) {
     ...
     */
    public void addChild(gdx.utils.JsonValue value) {
        if (type == gdx.utils.JsonValue.ValueType.object && value.name == null)
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue next() {
        return next;
    }
     ...
     */
    public void setNext(@Null gdx.utils.JsonValue next) {
        this.next = next;
    }
     ...
     * @return May be null.
     */
    public @Null gdx.utils.JsonValue prev() {
        return prev;
    }
     ...
     */
    public void setPrev(@Null gdx.utils.JsonValue prev) {
        this.prev = prev;
    }
    ...
    public void set(@Null String value) {
        stringValue = value;
        type = value == null ? gdx.utils.JsonValue.ValueType.nullValue : gdx.utils.JsonValue.ValueType.stringValue;
    }
    ...
    public void set(double value, @Null String stringValue) {
        ...
        type = gdx.utils.JsonValue.ValueType.doubleValue;
    }
    ...
    public void set(long value, @Null String stringValue) {
        ...
        doubleValue = value;
        this.stringValue = stringValue;
        type = gdx.utils.JsonValue.ValueType.longValue;
    }

    public void set(boolean value) {
        longValue = value ? 1 : 0;
        type = gdx.utils.JsonValue.ValueType.booleanValue;
    }
    ...
    private void json(gdx.utils.JsonValue object, StringBuilder buffer, OutputType outputType) {
        if (object.isObject()) {
     ...
     */
    public gdx.utils.JsonValue.JsonIterator iterator() {
        return new gdx.utils.JsonValue.JsonIterator();
    }
    ...
    public String trace() {
        if (parent == null) {
            if (type == gdx.utils.JsonValue.ValueType.array) return "[]";
            if (type == gdx.utils.JsonValue.ValueType.object) return "{}";
            return "";
        }
        String trace;
        if (parent.type == gdx.utils.JsonValue.ValueType.array) {
            trace = "[]";
            int i = 0;
            for (gdx.utils.JsonValue child = parent.child; child != null; child = child.next, i++) {
                if (child == this) {
                    trace = "[" + i + "]";
                    break;
                }
    ...
    public String prettyPrint(OutputType outputType, int singleLineColumns) {
        gdx.utils.JsonValue.PrettyPrintSettings settings = new gdx.utils.JsonValue.PrettyPrintSettings();
        settings.outputType = outputType;
        settings.singleLineColumns = singleLineColumns;
        return prettyPrint(settings);
    }

    public String prettyPrint(gdx.utils.JsonValue.PrettyPrintSettings settings) {
        StringBuilder buffer = new StringBuilder(512);
        prettyPrint(this, buffer, 0, settings);
        return buffer.toString();
    }

    private void prettyPrint(gdx.utils.JsonValue object, StringBuilder buffer, int indent, gdx.utils.JsonValue.PrettyPrintSettings settings) {
     ...
     */
    public void prettyPrint(OutputType outputType, java.io.Writer writer) throws java.io.IOException {
        gdx.utils.JsonValue.PrettyPrintSettings settings = new gdx.utils.JsonValue.PrettyPrintSettings();
        settings.outputType = outputType;
        prettyPrint(this, writer, 0, settings);
    }

    private void prettyPrint(gdx.utils.JsonValue object, java.io.Writer writer, int indent, gdx.utils.JsonValue.PrettyPrintSettings settings) throws java.io.IOException {
        OutputType outputType = settings.outputType;
        if (object.isObject()) {
            if (object.child == null)
                writer.append("{}");
    ...
    public class JsonIterator implements java.util.Iterator<JsonValue>, Iterable<JsonValue> {
        gdx.utils.JsonValue entry = child;
        gdx.utils.JsonValue current;

        public boolean hasNext() {
            return entry != null;
        }

        public gdx.utils.JsonValue next() {
            current = entry;
