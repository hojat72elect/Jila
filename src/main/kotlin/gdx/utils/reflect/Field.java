    ...
    public Class getElementType(int index) {
        ...
        if (genericType instanceof java.lang.reflect.ParameterizedType) {
            ...
            if (actualTypes.length - 1 >= index) {
                java.lang.reflect.Type actualType = actualTypes[index];
                ...
                else if (actualType instanceof java.lang.reflect.GenericArrayType) {
                    java.lang.reflect.Type componentType = ((java.lang.reflect.GenericArrayType) actualType).getGenericComponentType();
