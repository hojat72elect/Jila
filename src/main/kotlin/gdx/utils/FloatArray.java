...
public class FloatArray {
     ...
     * grown.
     */
    public FloatArray(gdx.utils.FloatArray array) {
     ...
     */
    static public gdx.utils.FloatArray with(float... array) {
        return new gdx.utils.FloatArray(array);
    }
    ...
    public void addAll(gdx.utils.FloatArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(gdx.utils.FloatArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(gdx.utils.FloatArray array) {
        int size = this.size;
        int startSize = size;
        float[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof gdx.utils.FloatArray)) return false;
        gdx.utils.FloatArray array = (gdx.utils.FloatArray) object;
