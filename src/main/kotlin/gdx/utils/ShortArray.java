...
/**
 * A resizable, ordered or unordered short array. Avoids the boxing that occurs with ArrayList<Short>.
 * If unordered, this class avoids a memory copy when removing elements (the last element is moved to
...
public class ShortArray {
     ...
     * grown.
     */
    public ShortArray(gdx.utils.ShortArray array) {
     ...
     */
    static public gdx.utils.ShortArray with(short... array) {
        return new gdx.utils.ShortArray(array);
    }
    ...
    public void addAll(gdx.utils.ShortArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(gdx.utils.ShortArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(gdx.utils.ShortArray array) {
        int size = this.size;
        int startSize = size;
        short[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof gdx.utils.ShortArray)) return false;
        gdx.utils.ShortArray array = (gdx.utils.ShortArray) object;
