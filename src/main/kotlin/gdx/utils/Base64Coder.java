...
public class Base64Coder {
    public static final Base64Coder.CharMap regularMap = new Base64Coder.CharMap('+', '/'), urlsafeMap = new Base64Coder.CharMap('-', '_');
    ...
    public static String encodeLines(byte[] in, int iOff, int iLen, int lineLen, String lineSeparator, gdx.utils.Base64Coder.CharMap charMap) {
    ...
    public static char[] encode(byte[] in, gdx.utils.Base64Coder.CharMap charMap) {
    ...
    public static char[] encode(byte[] in, int iOff, int iLen, gdx.utils.Base64Coder.CharMap charMap) {
    ...
    public static byte[] decodeLines(String s, gdx.utils.Base64Coder.CharMap inverseCharMap) {
     ...
     * @throws IllegalArgumentException If the input is not valid Base64 encoded data.
     */
    public static byte[] decode(String s, gdx.utils.Base64Coder.CharMap inverseCharMap) {
    ...
    public static byte[] decode(char[] in, gdx.utils.Base64Coder.CharMap inverseCharMap) {
        return decode(in, 0, in.length, inverseCharMap);
    }
    ...
    public static byte[] decode(char[] in, int iOff, int iLen, gdx.utils.Base64Coder.CharMap inverseCharMap) {
