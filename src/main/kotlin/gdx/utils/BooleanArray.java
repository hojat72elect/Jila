...
public class BooleanArray {
     ...
     * grown.
     */
    public BooleanArray(gdx.utils.BooleanArray array) {
     ...
     */
    static public gdx.utils.BooleanArray with(boolean... array) {
        return new gdx.utils.BooleanArray(array);
    }
    ...
    public void addAll(gdx.utils.BooleanArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(gdx.utils.BooleanArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(gdx.utils.BooleanArray array) {
        int size = this.size;
        int startSize = size;
        boolean[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof gdx.utils.BooleanArray)) return false;
        gdx.utils.BooleanArray array = (gdx.utils.BooleanArray) object;
