...
public class ObjectFloatMap<K> implements Iterable<ObjectFloatMap.Entry<K>> {
    ...
    float loadFactor;
    int threshold;
    transient ObjectFloatMap.Entries entries1, entries2;
    transient ObjectFloatMap.Values values1, values2;
    transient ObjectFloatMap.Keys keys1, keys2;
     ...
     */
    public gdx.utils.ObjectFloatMap.Entries<K> entries() {
        if (Collections.allocateIterators) return new gdx.utils.ObjectFloatMap.Entries(this);
        if (entries1 == null) {
            entries1 = new ObjectFloatMap.Entries(this);
            entries2 = new ObjectFloatMap.Entries(this);
        }
        if (!entries1.valid) {
            entries1.reset();
            entries1.valid = true;
     ...
     */
    public gdx.utils.ObjectFloatMap.Values values() {
        if (Collections.allocateIterators) return new gdx.utils.ObjectFloatMap.Values(this);
        if (values1 == null) {
            values1 = new gdx.utils.ObjectFloatMap.Values(this);
            values2 = new gdx.utils.ObjectFloatMap.Values(this);
        }
        if (!values1.valid) {
            values1.reset();
            values1.valid = true;
     ...
     */
    public gdx.utils.ObjectFloatMap.Keys<K> keys() {
        if (Collections.allocateIterators) return new ObjectFloatMap.Keys(this);
        if (keys1 == null) {
            keys1 = new ObjectFloatMap.Keys(this);
            keys2 = new ObjectFloatMap.Keys(this);
        }
        if (!keys1.valid) {
            keys1.reset();
            keys1.valid = true;
    ...
    static public class Entries<K> extends ObjectFloatMap.MapIterator<K> implements Iterable<ObjectFloatMap.Entry<K>>, java.util.Iterator<ObjectFloatMap.Entry<K>> {
        gdx.utils.ObjectFloatMap.Entry<K> entry = new ObjectFloatMap.Entry<K>();
    ...
    static public class Values extends ObjectFloatMap.MapIterator<Object> {
        ...
        public gdx.utils.ObjectFloatMap.Values iterator() {
            return this;
        }
    ...
    static public class Keys<K> extends ObjectFloatMap.MapIterator<K> implements Iterable<K>, java.util.Iterator<K> {
        ...
        public gdx.utils.ObjectFloatMap.Keys<K> iterator() {
            return this;
        }
