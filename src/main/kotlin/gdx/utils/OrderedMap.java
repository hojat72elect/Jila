...
public class OrderedMap<K, V> extends ObjectMap<K, V> {
    ...
    public Entries<K, V> entries() {
        if (Collections.allocateIterators) return new gdx.utils.OrderedMap.OrderedMapEntries(this);
        if (entries1 == null) {
            entries1 = new gdx.utils.OrderedMap.OrderedMapEntries(this);
            entries2 = new gdx.utils.OrderedMap.OrderedMapEntries(this);
        }
        if (!entries1.valid) {
            entries1.reset();
            entries1.valid = true;
    ...
    public Values<V> values() {
        if (Collections.allocateIterators) return new gdx.utils.OrderedMap.OrderedMapValues(this);
        if (values1 == null) {
            values1 = new gdx.utils.OrderedMap.OrderedMapValues(this);
            values2 = new gdx.utils.OrderedMap.OrderedMapValues(this);
        }
        if (!values1.valid) {
            values1.reset();
            values1.valid = true;
     ...
     */
    public Keys<K> keys() {
        if (Collections.allocateIterators) return new gdx.utils.OrderedMap.OrderedMapKeys(this);
        if (keys1 == null) {
            keys1 = new gdx.utils.OrderedMap.OrderedMapKeys(this);
            keys2 = new gdx.utils.OrderedMap.OrderedMapKeys(this);
        }
        if (!keys1.valid) {
            keys1.reset();
            keys1.valid = true;
